import { CUSTOM_FILTERS } from "./customFilters.js";
...
// Merge custom/local filters into FILTERS without modifying upstream's literal object definition
if (typeof CUSTOM_FILTERS === "object" && CUSTOM_FILTERS !== null) {
