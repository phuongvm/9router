  ...
  nous: {
    ...
    requestDeviceCode: async (config) => {
      ...
      return {
        ...
        verification_uri_complete: data.verification_uri_complete || (data.user_code ? `https://portal.nousresearch.com/device?user_code=${data.user_code}` : "https://portal.nousresearch.com/device"),
    ...
    pollToken: async (config, deviceCode) => {
      ...
      if (response.ok && data.access_token) {
        // Best-effort profile fetch to get user email (vmphuongit@gmail.com) for connection name
        let userEmail = null;
        try {
